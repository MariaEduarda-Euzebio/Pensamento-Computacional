Este repositório contém as atividades práticas e projetos desenvolvidos durante a disciplina de **Pensamento Computacional** no mês de abril, com foco na aplicação de lógica, algoritmos e abstração para a resolução de problemas.
